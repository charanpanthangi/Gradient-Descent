...
gb_classifier = train_evaluate_classifier(X_train_cls, X_test_cls, y_train_cls, y_test_cls)
with open('gb_classifier.pkl', 'wb') as file:
...
# Train and save Gradient Boosting Regressor
gb_regressor = train_evaluate_regressor(X_train_reg, X_test_reg, y_train_reg, y_test_reg)
...
print("Classifier Prediction for new input:", predict_with_model('gb_classifier.pkl', new_input_cls))
...
print("Regressor Prediction for new input:", predict_with_model('gb_regressor.pkl', new_input_reg))
